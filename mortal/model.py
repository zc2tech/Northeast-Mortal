...
from ne_consts import obs_shape, oracle_obs_shape, ACTION_SPACE, GRP_SIZE

class ChannelAttention(nn.Module):
    def __init__(self, channels, ratio=16, actv_builder: Callable = nn.ReLU, bias=True):
        super().__init__()
...
class ResBlock(nn.Module):
    def __init__(
        ...
        channels,
        *,
        norm_builder: Callable = nn.Identity,
        actv_builder: Callable = nn.ReLU,
        pre_actv = False,
    ):
        super().__init__()
